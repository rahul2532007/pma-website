      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10 py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10">
          <div className="col-span-2">
            ...
            <Link
              to="/book"
              className="mt-5 inline-flex items-center rounded-full bg-ink text-paper px-4 py-2 text-sm font-medium hover:opacity-90 transition"
            >
              Book a Consultation
            </Link>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/services/custom-websites">Custom Websites</Link>
              </li>
              <li>
                <Link to="/services/portfolio-websites">Portfolio</Link>
              </li>
              <li>
