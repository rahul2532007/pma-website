...
export const Route = createFileRoute("/services/custom-software")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Internal tools and platforms that compound your advantage.",
      },
      { property: "og:title", content: "Custom Software — Pride Digital" },
      { property: "og:description", content: "Software where templates won't do." },
      {
        property: "og:url",
        content: "https://pride-redesign-1.lovable.app/services/custom-software",
      },
    ],
    links: [
      { rel: "canonical", href: "https://pride-redesign-1.lovable.app/services/custom-software" },
    ],
    scripts: [
      {
