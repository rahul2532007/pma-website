...
const phases = [
  {
    n: "01",
    title: "Discover",
    body: "We audit your business, your buyer, and the funnel as it exists today. No assumptions.",
  },
  {
    n: "02",
    title: "Strategy",
    body: "Positioning, narrative, and information architecture — the load-bearing decisions.",
  },
  {
    n: "03",
    title: "Design",
    body: "Editorial systems with named decisions, not Figma mood boards.",
  },
  {
    n: "04",
    title: "Build",
    body: "Hand-coded, accessible by default, with a performance budget enforced from day one.",
  },
  {
    n: "05",
    title: "Launch",
    body: "Analytics, SEO, redirects, and QA wired before the cutover. No surprises.",
  },
  {
    n: "06",
    title: "Iterate",
    body: "Measurement-led changes for the first 90 days. Then a roadmap you control.",
  },
];
  ...
  return (
    <>
      <PageHeader
        ...
        lede="The same method whether the deliverable is a landing page or a platform — scoped to the stakes."
      />
