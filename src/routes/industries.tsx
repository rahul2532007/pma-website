...
export const Route = createFileRoute("/industries")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Sector specialism in legal, healthcare, creators, e-commerce, and SaaS.",
      },
...
const items = [
  {
    n: "01",
    title: "Legal",
    body: "Boutique and mid-market firms competing on positioning, not price.",
  },
  {
    n: "02",
    title: "Healthcare",
    body: "Multi-clinic groups, specialists, and digital-health startups.",
  },
  {
    n: "03",
    title: "Creators",
    body: "Directors, writers, and studios with a body of work to defend.",
  },
  ...
  return (
    <>
      <PageHeader
        ...
        lede="We refuse work outside these sectors. It keeps the studio sharp and the references real."
      />
          ...
          <div className="bg-ink text-paper p-10 min-h-[220px] flex flex-col justify-between">
            ...
            <div>
              ...
              <p className="mt-3 text-paper/70 text-sm">
                If your work fits the same standard, we'd like to hear about it.
              </p>
            </div>
          </div>
        </div>
