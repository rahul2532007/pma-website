...
export const Route = createFileRoute("/pricing")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Custom-scoped pricing. Honest ranges. No hidden line items.",
      },
...
const tiers = [
  {
    ...
    range: "$600",
    time: "10 days",
    body: "One page, one decision. Built for paid traffic.",
  },
  {
    name: "Custom Website",
    range: "$1,200",
    time: "6 weeks",
    body: "Brand site, hand-coded, fully owned.",
  },
  {
    name: "E-commerce",
    range: "$2,400",
    time: "8 weeks",
    body: "Shopify or headless, tuned for AOV and LTV.",
  },
  {
    name: "Custom Software",
    range: "$4,800",
    time: "8–16 weeks",
    body: "Internal tools, portals, bespoke platforms.",
  },
];
  ...
  return (
    <>
      <PageHeader
        marker="00"
        eyebrow="Pricing"
        title={<>Honest ranges. No hidden line items.</>}
        lede="Every engagement is scoped to your goals. These are realistic starting points — not catalog prices."
      />
      <section className="mx-auto max-w-7xl px-6 lg:px-10 py-16">
        ...
        <p className="mt-10 text-warm-5 max-w-2xl">
          Anything outside these brackets — retainers, ongoing growth, multi-region rollouts — gets
          a custom proposal after our consultation.
        </p>
      </section>
