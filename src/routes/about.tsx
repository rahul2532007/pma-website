...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A small senior studio of designers and engineers building websites and software that compound." },
    ...
    <>
      ...
      <Section>
        <div className="grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-4"><div className="section-marker">01 — Story</div></div>
          <div className="lg:col-span-8 space-y-5 text-warm-5 text-lg">
            <p className="font-display text-3xl text-ink leading-snug">Four people. Seven countries. One standard.</p>
            <p>Pride Digital is a distributed studio with senior practitioners in India, the US, the UK, the UAE, Canada, France, and Singapore. We staff projects with the people who'll actually do the work — no handoffs, no juniors learning on your budget.</p>
            <p>Our clients are founders, marketing leaders, and partners at firms where the website is a primary acquisition channel. We're the team they call when the stakes are real.</p>
          </div>
        </div>
      </Section>
          ...
          {team.map(p => (
            <div key={p.name} className="border border-rule p-6">
              <div className="aspect-square bg-warm-2 border border-rule overflow-hidden">
                <img src={p.photo} alt={`Portrait of ${p.name}, ${p.role} at Pride Digital`} className="w-full h-full object-cover" loading="lazy" />
              </div>
