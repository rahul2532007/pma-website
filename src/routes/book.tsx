...
export const Route = createFileRoute("/book")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Book a 30-minute strategy call with Pride Digital. Pick a time that works — we'll come prepared." },
  ...
  return (
    <>
      <PageHeader
        marker="00"
        eyebrow="Book"
        title={<>Book a 30-minute<br />consultation.</>}
          ...
          <aside className="lg:col-span-4 space-y-10">
            <div>
              ...
              <ol className="space-y-5">
                {[
                  ["01", "You pick a slot", "Choose any time on the calendar. You'll get a confirmation by email."],
                  ["02", "We do our homework", "Before the call we review your site, traffic, and competitors."],
                  ["03", "30 minutes, on the record", "Honest takes, concrete next steps. No pitch deck."],
                ].map(([n, t, b]) => (
            ...
            <div className="border-t border-rule pt-6">
              ...
              <ul className="space-y-2 text-sm">
                <li>Email: <a className="underline underline-offset-4" href="mailto:contact@pridemarketing.co.in">contact@pridemarketing.co.in</a></li>
                <li>WhatsApp: <a className="underline underline-offset-4" href="https://wa.me/" target="_blank" rel="noreferrer">Message us</a></li>
              </ul>
            </div>
          </aside>
          ...
          <div className="lg:col-span-8">
            <div className="border border-rule bg-paper">
              <div className="flex items-center justify-between px-5 py-3 border-b border-rule">
                ...
                <a href={CAL_URL} target="_blank" rel="noreferrer" className="text-xs underline underline-offset-4">
                  Open in new tab ↗
                </a>
              </div>
              <iframe
            ...
            <p className="mt-4 text-xs text-warm-4">
              ...
              <a href={CAL_URL} target="_blank" rel="noreferrer" className="underline underline-offset-4">
      ...
      <CTASection heading="Have a project brief already?" note="Send it over — we'll review before the call." />
    </>
  );
}
