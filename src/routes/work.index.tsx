...
export const Route = createFileRoute("/work/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Case studies across legal, healthcare, SaaS, and e-commerce.",
      },
  ...
  return (
    <>
      <PageHeader
        ...
        lede="A small selection from the last 18 months. The full deck is shared on consultation."
      />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {cases.map((c) => (
            <Link
              ...
              to="/work/$slug"
              params={{ slug: c.slug }}
              className="group border border-rule p-6 hover:bg-warm-1 transition"
            >
              ...
              <div className="mt-4 inline-flex items-center rounded-full border border-rule px-3 py-1 text-xs">
                {c.metric}
              </div>
            </Link>
          ))}
