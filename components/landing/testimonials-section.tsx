      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
            Ready to grow your business? Reach out through any of these channels
        ...
        >
          {contactMethods.map((method, index) => (
            <a
              ...
              className="group p-6 rounded-2xl border border-border bg-card hover:bg-muted/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg"
              style={{ transitionDelay: `${index * 100}ms` }}
            >
              <div
                className={`w-14 h-14 rounded-xl ${method.color} flex items-center justify-center mb-4 transition-transform group-hover:scale-110`}
              >
